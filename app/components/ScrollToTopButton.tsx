...
export default function ScrollToTopButton({
  ...
  return (
    <button
      ...
      className="fixed top-[160px] z-40 hidden h-11 w-11 items-center justify-center rounded-full border border-umami-light-gray bg-white shadow-md transition hover:bg-umami-light-gray/20 lg:flex"
